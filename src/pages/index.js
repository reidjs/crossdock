...
import { FancyButton, WarehouseStartButton, TruckerStartButton } from "../components/fancy-button"
  ...
  return (
    <Layout>
      ...
      <section className={`relative hero justify-center flex-col flex min-w-full items-center`}>
        ...
        <div id="why-crossdock" className={`md:absolute relative z-10 md:text-white flex flex-col ml-half sm:ml-0 p-8 md:pr-16`}>
          ...
          <p className={`text-2xl mb-2 text-shadow`}>Quick booking. Easy to use. Straightforward pricing<a id="why">.</a></p>
